...
print(tmed21se.info())### Bibliotecas Correlatas
import pandas as pd
import numpy as np
"""
import matplotlib.pyplot as plt               
...
print(tmax21.dtypes)
print("~"*80)
print(tmax21)### Bibliotecas Correlatas
import pandas as pd
import numpy as np
"""
import matplotlib.pyplot as plt               
...
print("="*80)
print(f"Máximo Focos_se: {focos21se.max().max()}, \n e Mínimo Focos_se: {focos21se.min().min()}.")
print("~"*30)
print(f"Máximo Casos_se: {casos21se.max().max()}, \n e Mínimo Casos_se: {casos21se.min().min()}.")
print("~"*30)
print(f"Máximo Precipitação_se: {merge21se.max().max()}, \n e Mínimo Precipitação_se: {merge21se.min().min()}.")
print("~"*30)
print(f"Máximo TempMín_se: {tmin21se.max().max()}, \n e Mínimo TempMín_se: {tmin21se.min().min()}.")
print("~"*30)
print(f"Máximo TempMed_se: {tmed21se.max().max()}, \n e Mínimo TempMed_se: {tmed21se.min().min()}.")
print("~"*30)
print(f"Máximo TempMáx_se: {tmax21se.max().max()}, \n e Mínimo TempMáx_se: {tmax21se.min().min()}.")
print("="*80)
print("="*80)
