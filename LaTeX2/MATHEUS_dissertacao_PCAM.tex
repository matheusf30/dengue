...
\newacronym{CPTEC}{CPTEC}{Centro de Previsãoo de Tempo e Estudos Climáticos}
...
\newacronym{DENV}{DENV}{vírus Dengue}
...
Ao avanço e\\ persistência\\ da ciência,\\ principal-\\mente nos\\ períodos \\mais \\contur-\\bados. 

A todos \\que \\tiveram\\ a vida \\cessada

\vspace{50}

por falsa\\ informação,\\ desinformação\\ ou negação\\ da mesma.
