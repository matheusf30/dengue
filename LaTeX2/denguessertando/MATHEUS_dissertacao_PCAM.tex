...
\newacronym{GSM}{GSM}{Global Spectral Model}
\newacronym{FV3}{FV3}{Finite-Volume Cubed-Sphere}
\newacronym{CFS}{CFS}{Climate Forecast System}
...
\newacronym{SCM}{SCM}{Sistemas Convectivos de Mesoescala}
...
\newacronym{RNAM}{RNAM}{Rede Neural Artificial Multicamada}
...
\newacronym{OMSA}{OMSA}{Organização Mundial de Saúde Animal}
\newacronym{OPAS}{OPAS}{Organização Pan-Americana da Saúde}
\newacronym{RIMSA}{RIMSA}{Reunião Interamericana de Nível Ministerial sobre Saúde e Agricultura}
\newacronym{PNUMA}{PNUMA}{Programa das Nações Unidas para o Meio Ambiente}
\newacronym{SGISU}{SGISU}{Sistema Global de Inteligência em Saúde Única}
\newacronym{OIE}{OIE}{Office International des Epizooties}
...
\newacronym{CNSU}{CNSU}{Comissão Nacional de Saúde Única}
...
\newacronym{CIGERD}{CIGERD}{Centro Integrado de Gestão de Riscos e Desastres}
\newacronym{SIFAP}{SIFAP}{Sistema Integrado de Ferramentas de Análise e Previsão Hidrometeorológica}
...
\newacronym{PNMA}{PNMA}{Política Nacional do Meio Ambiente}
...
\newacronym{RSI}{RSI}{Regulamento Sanitário Internacional}
\newacronym{ESPIN}{ESPIN}{Emergência em Saúde Pública de Importância Nacional}
\newacronym{fnsus}{FN-SUS}{Força Nacional do Sistema Único de Saúde}
\newacronym{SUS}{SUS}{Sistema Único de Saúde}
\newacronym{DataSUS}{DataSUS}{Departamento de Informática do Sistema Único de Saúde}
\newacronym{PNVS}{PNVS}{Política Nacional de Vigilância em Saúde}
\newacronym{Dive}{Dive}{Diretoria de Vigilância Epidemiológica}
\newacronym{LACEN}{LACEN}{Laboratório Central de Saúde Pública}
\newacronym{COE}{COE}{Centro de Operação de Emergência}
%\newacronym{DENV}{DENV}{vírus da dengue}
\newacronym{ssRNA+}{ssRNA+}{single-stranded and positive-sense Ribonucleic Acid}
...
\newacronym{SAE}{SAE}{Série de Anomalia Estacionária}
\newacronym{SSS}{SSS}{Série Sem Sazonalidade}
...
\newacronym{SVSA}{SVSA}{Secretaria de Vigilância em Saúde e Ambiente}
...
\newacronym{EQM}{EQM}{Erro Quadrático Médio}
...
% ECOEPIDEMIOLOGIA DE ARBOVIROSES NO ESTADO DE SANTA CATARINA}

% \titulo{VARIABILIDADE CLIMÁTICA E SAÚDE ÚNICA:\\
% GEOMEDICINA APLICADA A ARBOVIROSES\\
% VETORIZADAS POR \latim{Aedes aegypti} (Linnaeus, 1762)\\
% NO ESTADO DE SANTA CATARINA}

%  \titulo{VARIABILIDADE CLIMÁTICA E SAÚDE ÚNICA:\\
% GEOMEDICINA APLICADA AO VETOR BIOLÓGICO\\
% \latim{Aedes aegypti} (Linnaeus, 1762)\\ %NÃO UTILIZAR AUTOR NO TÍTULO
% NO ESTADO DE SANTA CATARINA}

% \titulo{VARIABILIDADE CLIMÁTICA E SAÚDE ÚNICA:\\
% Relação entre os Elementos Meteorológicos e o Vetor Biológico\\
% \latim{Aedes aegypti}\\
% no Estado de Santa Catarina}

% \titulo{Papel dos elementos meteorológicos na reprodução do \latim{Aedes aegypti}\\ no Estado de Santa Catarina}

% \titulo{Utilização de Produtos Meteorológicos de Reanálise para\\Análise de Relação de Focos de  \latim{Aedes} sp. e Casos de Dengue\\no Estado de Santa Catarina}

% \titulo{Análise das Relações entre Produtos Meteorológicos de Reanálise,\\Focos de  \latim{Aedes} sp. e Casos de Dengue no Estado de Santa Catarina}

\titulo{Análise das Relações entre Elementos Climatológicos,\\Focos de  \latim{Aedes} sp. e Casos de Dengue no Estado de Santa Catarina}
...
\begin{dedicatoria}
    \vspace*{\fill}
	\begin{flushright}
    Dedico este trabalho ao avanço e persistência da ciência, especialmente nos períodos conturbados. Também dedico a todos que tiveram a vida cessada, seja por falsa informação, desinformação ou negação da ciência. 

% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{|||||||||| \textcolor{white}{AO AVANÇO}}\\
% \fcolorbox{red}{red}{  \textcolor{white}{E PERSISTÊNCIA}}\\
% \fcolorbox{red}{red}{||||||||| \textcolor{white}{DA CIÊNCIA,}}\\
% \fcolorbox{red}{red}{\textcolor{white}{PRINCIPALMENTE}}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||| \textcolor{white}{NOS}}\\
% \fcolorbox{red}{red}{|||||||||||| \textcolor{white}{PERÍODOS}}\\
% \fcolorbox{red}{red}{ \textcolor{white}{CONTURBADOS. }}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{|||||||||||||||||||||||||||||||||}\\
% \fcolorbox{red}{red}{||||||||||||||| \textcolor{white}{A TODOS}}\\
% \fcolorbox{red}{red}{|||||||||| \textcolor{white}{QUE A VIDA}}\\
% \fcolorbox{red}{red}{||||||||||||| \textcolor{white}{CESSOU...}}\\
% \vspace{1.15cm}

% \fcolorbox{red}{red}{|||||||| \textcolor{white}{...POR FALSA}}\\
% \fcolorbox{red}{red}{|||||| \textcolor{white}{INFORMAÇÃO,}}\\
% \fcolorbox{red}{red}{\textcolor{white}{DESINFORMAÇÃO}}\\
% \fcolorbox{red}{red}{||||||| \textcolor{white}{OU NEGAÇÃO}}\\
% \fcolorbox{red}{red}{||||||||||| \textcolor{white}{DA MESMA.}}
...
\indent Agradeço, antes de tudo, a minha família, pelo suporte prestado, especialmente ao meu pai e minha mãe.

\indent Agradeço ao orientador, por não estar tão próximo, confiando e deixando seguir com minhas próprias pernas; ao mesmo tempo em que não está tão longe, dando apoio sempre que necessário. Essa é a primeira vez, durante minha vida acadêmica, que tenho uma pessoa para me orientar e, diga-se de passagem, que excelente pessoa.

\indent Igualmente, agradeço aos co-orientadores, que nos poucos debates ocorridos, foram decisivos para sanar dúvidas. Assim como também agradeço à banca, sejam titulares ou suplentes, por sinalizar disponibilidade e contribuir com o projeto.

\indent Nominalmente, e começando pela turma, devo um enorme agradecimento à Ana Paula Marcon Hanada, prestando socorro, mesmo após ter defendido; Glenda Fauth e João Manoel Nascimento, pelos bons momentos de debate rumo a Itajaí; e um especial agradecimento à Lua, Maria Rita lua de Quadro, por enorme apoio e ombro amigo, mantendo-me no programa, além de ser "co-orientadora não oficial".

\indent Agradeço aos egressos do Programa, principalmente a Cleusa Matiola, Roseli de Oliveira, Caio Guerra de Oliveira e Alfeu Luz Losso. Uma breve conversa, seja com café ou com chopp, rendem soluções eficientes. Também agradeço aos "calouros" Mabel Simm Milan Bueno, Diogo Ricardo Roesner e Erasmo Carlos Ferreira, por buscarem soluções conjuntas aos problemas semelhantes.

\indent Em relação aos bolsistas, agradeço aos momentos de "descompressão" com café, especialmente a Julia Barreto da Silva, Everton Weber Galliani, Amanda Rodrigues Joris, Beatriz Campanharo Garcia Carneiro e Maitê Ocker. A pausa (da tela) é necessária, mesmo que a conversa continue científica; tudo nos é dado, só nos falta fé. 

\indent Externamente ao programa, não posso deixar de agradecer a Laynara da Silva Vieira e Elmo dos Santos Neto, por me iniciarem e continuarem me ajudando na linguagem da programação; e pelo suporte logístico e pscicológico, eterna gratidão a Daniele Freitas Pacheco, Renan Osvaldo Pacheco, Alice Deorrist Rampon e Claudete Medeiros. Meu agradecimento ao Anderson Spohr Nedel, por debates e oportunidades em biometeorologia, agregando muito ao projeto.

\indent Assim como também devo agradecer aos professores, do Ifsc campus Garopaba, Sandra Beatriz Koelling, por me confiar bolsista do projeto ArteEducação e ao João Henrique Quoos, por comentar sobre o edital de seleção do mestrado e continuar dando dicas tão boas quanto...

\indent - "Sério? O Ifsc tem programa de mestrado?"

\indent - "Sim... Público, gratuito e de qualidade!"
...
A dengue é uma doença viral infecciosa, transmitida pela picada da fêmea do mosquito \latim{Aedes aegypti} (Linnaeus, 1762) e \latim{Aedes albopictus} (Skuse, 1895). Atualmente é um dos principais problemas de saúde coletiva no mundo. Está presente nas regiões tropicais e subtropicais do planeta, sendo estimado que 390 milhões de pessoas sejam infectadas anualmente pelos quatro sorotipos. Há tendência de resposta à sazonalidade em relação ao número de focos de dengue, na qual os meses com temperaturas mais elevadas se observa crescimento, principalmente quando retroagidos por um período de 30 dias; e tem diminuição nos meses mais frios. Logo, temperatura é um elemento crítico para o desenvolvimento do mosquito. A geomedicina proporciona base para o próprio estudo espacializado de doenças. Sendo assim, a seguinte proposta tem o objetivo direto de observar a relação entre a distribuição de casos de dengue, número de focos dos vetores biológicos do gênero \latim{Aedes} (Meigen, 1818), transmissores do vírus da dengue no Estado de \acrlong{SC}, e o comportamento de elementos climáticos. Foram utilizados dados de temperaturas (mínima, máxima e média) do \ingles{\acrfull{SAMeT}} e precipitação do \ingles{\acrfull{MERGE}}, assim como dados do \ingles{\acrfull{GFS}} para modelagem preditiva. Percebe-se, através da sazonalidade anual em \acrlong{SC}, regiões de maior incidência de casos de dengue e com maior proliferação de \latim{Aedes} sp., justamente onde se apresentam os maiores valores de temperaturas. As regiões serranas, patamares e planaltos do Estado catarinense demonstram ser limitantes naturais para ocorrência do vetor e, consequentemente, da doença. No Estado de \acrlong{SC}, os picos de dengue comumente ocorrem durante o outono austral. Há correlação média a alta negativa ao relacionar casos de dengue e limiares de temperaturas retrocedidos no tempo nos municípios de Florianópolis, Itajaí, Joinville e Chapecó. Durante o processo de aprendizado de máquina, modelagem por \ingles{Random Forest} apresentou melhores respostas de predição, quando comparado a modelos por \acrfull{RNAM}. Ao analisar histogramas dos erros, modelagens preditivas nos municípios de Florianópolis e Joinville obtiveram adensamento do erro próximo a zero (0), porém sugerem valores de previsão subestimados. o \acrfull{PTT} demonstra capacidade preditiva de 14 dias (2 semanas epidemiológicas) para os casos de dengue no Estado de \acrlong{SC}, sendo visualizado por cartografia preditiva em semanas epidemiológicas. Investigar esses múltiplos aspectos e compreender essas informações auxiliam no processo de tomada de decisões, buscando, assim, uma melhor resposta frente a zoonoses emergentes e re-emergentes.
...
\begin{resumo}[Abstract]
 ...
 Dengue is an viral infectious disease transmitted by the female mosquito \latim{Aedes aegypti} (Linnaeus, 1762) and \latim{Aedes albopictus} (Skuse, 1895). Nowadays, it is one of the main public health problems in the world. It is present in the tropical and subtropical regions of the planet, with an estimated 390 million people are infected annually with all four serotypes. There is a trend to respond to seasonality in relation to the number of dengue outbreaks, in which the months with higher temperatures are observed increase, mainly when retroacted for a period of 30 days; and observe decrease in the colder months. Therefore, temperature is a critical element for the growth of the mosquito. Geomedicine provides a basis for the spatialized study of diseases. Thus, this project has the direct objective of observing the relationship between the distribution of dengue cases, proliferation of the biological vector of genus \latim{Aedes} (Meigen, 1818), the main vector to transmit arboviruses in the \acrlong{SC} State, and the climate elements. The data of temperatures (max., mean and min.) were used from the \acrfull{SAMeT} and precipitation data from \acrfull{MERGE}, and so \acrfull{GFS} to prediction. It is observed, through the annual seasonality in \acrlong{SC} State, that regions with higher incidence of dengue cases and greater proliferation of \latim{Aedes} sp. are precisely those with the highest temperature values. Some regions in \acrlong{SC} demonstrate natural limitations for the occurrence of the vector and, consequently, the disease, like mountain range and plateaus. In the \acrlong{SC} State, dengue outbreaks commonly occur during the austral autumn. There is a medium to high negative correlation when relating dengue cases with temperature thresholds lagged in time in the municipalities of Florianópolis, Itajaí, Joinville, and Chapecó. During the machine learning process, Random Forest models showed better prediction results when compared to Multi-layer Artificial Neural Network modeling. When analyzing the histograms of errors, predictive models for the municipalities of Florianópolis and Joinville showed error density close to zero (0), but suggested underestimated forecast values. The Technical-Technological Product (in portuguese, \ingles{\acrfull{PTT}}) demonstrates predictive capacity for 14 days (2 epidemiological weeks) for dengue cases in the state of \acrlong{SC}, which is visualized through predictive cartography in epidemiological weeks. Investigate these multiple aspects and understand this information assist in the decision-making process, thus seeking a better response to emerging and reemerging  zoonotic diseases. 
...
\include{tex/1-intro} % Introdução + Justificativa + Objetivos
\include{tex/2-fundamenteo} % Fundamentação Teórica
\include{tex/3-meto} % Metodologia + Métodos Aplicados
\include{tex/4-resultados} % Resultados + Análises + Discussões
\include{tex/5-consfinais} % Considerações Finais
\include{tex/6-futura} % Futuros Trabalhos + Sugestões Futuras
...
%-------------------Update MATHEUS_dissertacao_PCAM.tex--------------------------------------------------
% INDICE REMISSIVO
%---------------------------------------------------------------------
%\phantompart
%\printindex
...
\end{document}
% cartografia_preditiva_casos.py
