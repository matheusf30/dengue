...
\indent As quatro (4) cidades elencadas nos estudos foram: Florianópolis, Itajaí, Joinville e Chapecó; por apresentarem frequência e volume de dados, além de representarem regiões populosas e distintas. Sobre as correlações (figura \ref{fig: matriz_corr_DEE}), realizadas pelo método de \textcolor{red}{Spearman}, o máximo de retroação foi em 16 semanas epidemiológicas entre casos de dengue e focos de \latim{Aedes} sp.

\begin{figure}[htbp]
    \centering
    \caption{Matriz de correlações de alguns municípios catarinenses durante 2023, método de Spearman.}
    \label{fig: matriz_corr_DEE}
    \subfigure[Florianópolis]{
