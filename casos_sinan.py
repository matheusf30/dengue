"""
AO BAIXAR OS DADOS BRUTOS DO SISTEMA DE INFORMAÇÃO DE AGRAVOS DE NOTIFICAÇÃO - ESTADO DE SANTA CATARINA, EXECUTE:
	une_casos_sinan.py
ASSIM, SERÃO GERADOS NOVOS ARQUIVOS:
	\casos_sinan_total.csv
